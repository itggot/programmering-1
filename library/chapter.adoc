...
| "examples are hard\nexamples are hard\nexamples are hard"| "are hard" | "examples \nexamples \nexamples "
...
remove_string("examples are hard\nexamples are hard\nexamples are hard", "are hard") #=> "examples \nexamples \nexamples " 
...
replace_string("examples are hard\nexamples are hard\nexamples are hard", "hard", "\"tough\"") #=> "examples are \"tough\"\nexamples are \"tough\"\nexamples are \"tough\"" 
